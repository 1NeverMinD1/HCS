      ...
      <div className="blogscontent">
        ...
        <div className="blogscontent__header">
          ...
          <div className="blogscontent__author">
            ...
            <p className="spec">{blogs.position}</p>
          </div>
        </div>
        ...
        <h2 className="blogscontent__title">{blogs.title}</h2>
        <img src={imgUrl} alt="desc_img" className="blogscontent__img" />
        <hr />
        <div className="blogscontent__main">
          {blogs.content?.map((block, i) => renderBlock(block, i))}
        </div>
        <div className="blogscontent__footer">
          <div className="likes">
