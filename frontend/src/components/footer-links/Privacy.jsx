...
const POPULATE_QUERY = `populate[PrivacyContent][populate]=*`;
...
export default function Privacy() {
  ...
  useEffect(() => {
    fetch(`https://api.zhkh24.kz/api/footer-privacy?${POPULATE_QUERY}`)
      .then((res) => res.json())
  ...
  const content =
    page.PrivacyContent?.[`content_${locale}`] ||
    page.PrivacyContent?.content_ru ||
    [];
