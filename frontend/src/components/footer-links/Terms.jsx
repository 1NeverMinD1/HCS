...
const POPULATE_QUERY = `populate[TermsContent][populate]=*`;
...
export default function Privacy() {
  ...
  useEffect(() => {
    fetch(`https://api.zhkh24.kz/api/footer-term?${POPULATE_QUERY}`)
      .then((res) => res.json())
  ...
  const content =
    page.TermsContent?.[`content_${locale}`] ||
    page.TermsContent?.content_ru ||
    [];
